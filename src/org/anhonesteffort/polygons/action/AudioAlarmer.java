...
public class AudioAlarmer extends IntentService {
  private static final String TAG = "AuidoAlarmer";
  ...
  protected void onHandleIntent(Intent intent) {
    ...
    if(loaded) {
      ...
      soundPool.play(soundID, 1, 1, 1,
                       Integer.parseInt(settings.getString(PreferencesActivity.PREF_AUDIO_ALARM_LENGTH, "30")), 1);
    }
    else
